    ...
    <div class="layui-row">
        <form class="layui-form">
            ...
            <div class="layui-form-item layui-form-text">
                <label for="content" class="layui-form-label" style="width:90px;padding-left: 5px;">
                    <span class="x-red">*</span>商品种类名称：
                </label>
                <div class="layui-input-block">
                    <input type="text" id="categoryName" name="categoryName" required="" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            form.on('submit(publish)',
                function(data) {
                    ...
                    $.ajax({
                        ...
                        error:function(){
                            layer.alert('网络错误！商品种类添加失败！', {icon: 5});
                        }
                    });//end ajax
