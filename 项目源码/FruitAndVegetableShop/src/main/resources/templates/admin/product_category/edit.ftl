    ...
    <div class="layui-row">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                <label for="username" class="layui-form-label" style="width:90px;padding-left: 5px;">
                    <span class="x-red">*</span>商品种类名称：</label>
                <div class="layui-input-inline">
                    <input type="text" id="categoryName" name="categoryName" value="${ProductCategory.categoryName!""}" required="" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            form.on('submit(edit)',
                function(data) {
                    ...
                    $.ajax({
                        ...
                        error:function(){
                            layer.alert('网络错误！商品种类编辑失败！', {icon: 5});
                        }
                    });//end ajax
