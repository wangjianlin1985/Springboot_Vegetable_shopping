...
<html class="x-admin-sm">
                ...
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="name" name="name" value="${editRole.name!""}" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        window.onload=function(){
        	$("#description").val('${editRole.description!""}');
        }
                ...
                function(data) {
                	...
                	console.log(editForm);
              		...
              		$.ajax({
						...
						error:function(){
							layer.alert('网络错误！编辑角色失败！', {icon: 5}); 
						}
					});//end ajax
