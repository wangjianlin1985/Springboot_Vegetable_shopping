        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="username" name="username" readonly="readonly" value="${User.username!""}" required="" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="password" id="passwd" name="passwd" value="${User.password!""}" required="" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            form.on('submit(edit)',
                function(data) {
                    ...
                    $.ajax({
                        ...
                        error:function(){
                            layer.alert('网络错误！修改用户密码失败！', {icon: 5});
                        }
                    });//end ajax
